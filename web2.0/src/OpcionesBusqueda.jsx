        ...
        <div name="opciones-de-busqueda" className="flex flex-col px-7 mt-4">
            ...
            <div className="flex flex-row">
                <div className="flex flex-row space-x-2">
                    <div id="buscarEventoDiv" className="bg-white py-1 w-70 h-10 rounded-lg border-rosa border-3 border-solid flex items-center flex-row justify-between">
                    ...
                    <button id="ordenarEventosBoton" className="bg-white hover:border-gris py-1 w-40 h-10 rounded-lg border-rosa border-3 border-solid flex items-center flex-row justify-between">
